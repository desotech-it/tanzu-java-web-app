...
{
  "bsGitBranch" : "main",
  "bsGitRepository" : "github.com?owner=desotech-it&repo=tanzu-java-web-app",
  "projectName" : "tanzu-java-web-app",
  "repositoryPrefix" : "r.deso.tech/tanzu-java-web-app"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [your-registry.io/project->r.deso.tech/tanzu-ja...(truncated)]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=desotech-it&repo=tanzu-java-web-app'
